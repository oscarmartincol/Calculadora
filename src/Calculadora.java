...
public class Calculadora {
    ...
    private void dividir(){
        // Si el número ingresado es diferente de cero se hace la divisiÃ³n de lo contrario arroja error.
        if(this.num != 0) {
            this.resultNow /= this.num;
        }else {
    ...
    private void seleccionarOperacion(String operacion, Scanner input){
        switch (operacion) {
            ...
            case "/" -> {
                System.out.println("Ingrese el número por el que quiere dividir");
                this.num = input.nextDouble();
                dividir();
            }
            default -> {
